...
async def test_create_instance(app_client, api_key, mock_provisioner):
    ...
    async with app_client as ac:
        ...
        response = await ac.post(
            "/instances", headers=headers, json={"name": "test-instance"}
        )
...
@pytest.mark.asyncio
async def test_list_instances_route(
    app_client, mock_instances_collection_with_data, api_key
):
...
@pytest.mark.asyncio
async def test_get_instance_route(
    app_client, mock_instances_collection_with_data, instance_id, api_key
):
...
@pytest.mark.asyncio
async def test_update_instance_route(
    app_client, mock_instances_collection_with_data, instance_id, api_key
):
...
@pytest.mark.asyncio
async def test_delete_instance_route(
    app_client, mock_instances_collection_with_data, instance_id, api_key
):
